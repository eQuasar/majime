              ...
              <b-row>
                ...
                <b-col xl="6" lg="6" md="6">
                  <button
                    ...
                    v-on:click="ProcessingList_download"
            ...
            <div class="groomer-page">
              ...
              >
                ...
                <template v-slot:cell(action)="row">
                  <p class="h3 mb-2">
                    <b-link @click="assignAWBOrder(row.item.oid)"
                      ><b-icon
...
export default {
  ...
  methods: {
    ...
    addstatus() {
      ...
      this.$bvModal
        .msgBoxConfirm(`Are You Sure Want to Change Confirm Status`, {
          id: modalId,
        })
        .then((wasOkPressed) => {
          this.show = true;
    ...
    getvendor() {
      ...
      order
        .getProcessing_OrderDetails(formData)
        .then((response) => {
    ...
    getonHolddata(vid) {
      order
        .getProcessing_data(vid, "on-hold")
        .then((response) => {
          if (response.data) {
            this.items = response.data;
          }
