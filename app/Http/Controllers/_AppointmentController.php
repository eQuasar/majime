...
class AppointmentController extends Controller
{
    ...
    {
        //
        $appointment= Appointment::whereDate('date','>=',date('Y-m-d'))->where('status','!=',5)->where('status','!=',6)->get();
    ...
    {
        $appointment1_main = Appointment::whereDate('date','>=',date('Y-m-d'))->where('status','!=',5)->where('status','!=',6)->get();
